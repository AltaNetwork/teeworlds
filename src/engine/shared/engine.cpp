...
public:
	...
	void Init()
	{
		...
		m_pConsole->Register("dbg_dumpmem", "", CFGFLAG_SERVER, Con_DbgDumpmem, this, "Dump the memory");
		m_pConsole->Register("dbg_lognetwork", "", CFGFLAG_SERVER, Con_DbgLognetwork, this, "Log the network");
	}
