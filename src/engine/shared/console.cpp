...
{
	//dbg_msg(pFrom ,"%s", pStr); // removed, instead showing when level <= outputlevel
...
CConsole::CConsole(int FlagMask)
{
	...
	Register("echo", "r", CFGFLAG_SERVER, Con_Echo, this, "Echo the text");
	Register("exec", "r", CFGFLAG_SERVER, Con_Exec, this, "Execute the specified file");

	Register("toggle", "sii", CFGFLAG_SERVER, ConToggle, this, "Toggle config value");
