...
MACRO_CONFIG_STR(SvGametype, sv_gametype, 32, "dm", CFGFLAG_SERVER, "Gametype ((g/i)dm, (g/i)tdm, (g/i)ctf, [i|g]freeze, (g/i)htf, (g/i)thtf, (g/i)lms, (g/i)lts, ndm)")
...
MACRO_CONFIG_INT(SvKillSound, sv_kill_sound, 1, 0, 1, CFGFLAG_SERVER, "Whether or not to enable kill sounds")
...
// info shown on /info
MACRO_CONFIG_STR(SvInfoGithub, sv_info_github, 128, "nigga veqi made this", CFGFLAG_SERVER, "Github link shown when /info is used")
MACRO_CONFIG_STR(SvInfoContact, sv_info_contact, 128, "no contact!", CFGFLAG_SERVER, "Contact link shown when /info is used")
